...
**Status:** Production (xubb_agents v2.1.1 Compliant)
...
|---------|------|---------|
| 2.5 | Mar 19, 2026 | Updated for xubb_agents v2.1: Jinja2 templates now sandboxed (`SandboxedEnvironment`). Templates accessing Python internals (`__class__`, `__globals__`, `__mro__`) will raise `jinja2.SecurityError`. All documented template patterns continue to work unchanged. |
