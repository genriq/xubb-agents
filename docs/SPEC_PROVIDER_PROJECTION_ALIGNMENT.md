...
**Version:** 1.1 · 2026-09-24 · **Status:** SHIPPED — merged to `main` as PR #59 (2026-09-24), for 3.2.1; released on the 3.1 line as **3.1.7** (PR #60, tagged `v3.1.7` at `854b592`, 2026-09-24).
