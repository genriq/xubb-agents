...
**Version:** 2.8.0
**Status:** PROPOSED — 2026-09-12; implemented in the same change, spec-first per [PROCESS.md](PROCESS.md): every item below lands with a registered contract (`CONTRACTS.yaml`), a rule-asserting test and its negative control. The status becomes IMPLEMENTED with the 2.8.0 release.
