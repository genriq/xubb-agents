...
- **Status:** SHIPPED — merged as PR #42 (2026-09-14), first released as 3.1.0 (`v3.1.0` at `b4ce54b`). Two rounds of post-implementation review followed, repaired in **3.1.1** (PR #44) and **3.1.2** (PR #46); see §17 for what they found and the [CHANGELOG](../CHANGELOG.md) for the current release. Not yet adopted by any host.
